...
#ifndef D_CH32V103_HITSIC_COMMON_H_
#define D_CH32V103_HITSIC_COMMON_H_

#include "stdint.h"
#include "inc_hal_ch32f10x.h"
...
typedef I2C_TypeDef HAL_I2C_Type;
typedef SPI_TypeDef HAL_SPI_Type;
typedef USART_TypeDef HAL_UART_Type;
...
inline void HAL_EnterCritical(void)
{
    ...
    {
        //hal_regPrimask = DisableGlobalIRQ(); //TODO
    }
}
...
inline void HAL_ExitCritical(void)
{
    ...
    {
        //EnableGlobalIRQ(hal_regPrimask); //TODO
    }
}
...
#endif // ! D_CH32V103_HITSIC_COMMON_H_
